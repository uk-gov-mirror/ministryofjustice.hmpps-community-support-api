...
data class AdditionalSupportNeedsBffResponseDto(
  ...
  companion object {
    fun fromNeeds(person: Person, personAdditionalSupportNeeds: PersonAdditionalSupportNeeds): AdditionalSupportNeedsBffResponseDto = AdditionalSupportNeedsBffResponseDto(
      ...
      physicalHealth = SelectionDto.fromString(personAdditionalSupportNeeds.physicalHealthDetails),
      mentalEmotionalHealth = SelectionDto.fromString(personAdditionalSupportNeeds.mentalEmotionalHealthDetails),
      neurodiversity = SelectionDto.fromString(personAdditionalSupportNeeds.neurodiversityDetails),
      locationTravel = SelectionDto.fromString(personAdditionalSupportNeeds.locationTravelDetails),
      caringResponsibilities = SelectionDto.fromString(personAdditionalSupportNeeds.caringResponsibilitiesDetails),
      employmentResponsibilities = SelectionDto.fromString(personAdditionalSupportNeeds.employmentResponsibilitiesDetails),
      diversity = SelectionDto.fromString(personAdditionalSupportNeeds.diversityDetails),
      anythingElse = SelectionDto.fromString(personAdditionalSupportNeeds.anythingElseDetails),
  ...
  companion object {
    fun from(person: Person, personAdditionalSupportNeeds: PersonAdditionalSupportNeeds): NeedsInterpreterBffResponseDto {
      ...
      return when (personAdditionalSupportNeeds.interpreterNeeded) {
        true -> NeedsInterpreterBffResponseDto(refereeName, SelectionDto.fromString(personAdditionalSupportNeeds.interpreterLanguage))
